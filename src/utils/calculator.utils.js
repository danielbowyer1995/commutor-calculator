...
export async function getDestination() {
  ...
  axios
    .get(`https://api.postcodes.io/postcodes/${destinationPostCode}`)
    .then((res) => {
...
export async function getHomeLocation() {
  ...
  axios
    .get(`https://api.postcodes.io/postcodes/${homePostCode}`)
    .then((res) => {
...
export const getTravelDetails = () => {
  axios
    .get(
      `https://api.tfl.gov.uk/Journey/JourneyResults/${FormStore.homePostCode}/to/${FormStore.destinationPostCode}&mode=walking,train,nation-rail&nationalSearch=true`,
    )
    .then((res) => {
      console.log(res)
...
export const getFareInfo = () => {
  axios.get('https://api.tfl.gov.uk/Stoppoint/490G01177G/FareTo/490G00012371').then((res) => {
    console.log(res)
  })
}
...
export const getFarePrice = (zoneOne, zoneTwo) => {
  if (zoneOne === 1 && zoneTwo === 9) {
    ...
    TravelStore.trainTravelCost = 37.5
  }
